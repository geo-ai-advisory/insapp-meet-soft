    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            {isProcessing
              ? progress?.message || 'Обрабатываю аудио...'
              : error
              ? 'При загрузке произошла ошибка'
              : 'Загрузи аудио-файл, чтобы создать встречу с транскриптом'}
          </DialogDescription>
        </DialogHeader>
              ...
              {fileInfo ? (
                <div className="bg-background rounded-lg p-4 space-y-3">
                  ...
                  <div className="space-y-1">
                    <label className="text-sm font-medium text-foreground">Название встречи</label>
                    <Input
                      value={title}
                      onChange={(e) => {
                      ...
                      placeholder="Введи название встречи"
                    />
                  </div>
              ...
              {fileInfo && (
                <div className="border rounded-lg">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 text-sm font-medium text-foreground hover:bg-secondary"
                  >
                      ...
                      {!isParakeetModel ? (
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Parakeet не поддерживает выбор языка - всегда автоопределение.
                          </p>
                        </div>
                      )}
