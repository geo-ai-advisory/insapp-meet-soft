        ...
        <div className="space-y-6 py-4">
          ...
          <div className="flex flex-col gap-3 pt-2">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full px-4 py-3 border-2 border-border text-foreground rounded-lg hover:bg-secondary disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors"
            >
