  ...
  return (
    <div
      className={cn(
        ...
        isAuthorized ? 'border-gray-900 bg-secondary' : isDenied ? 'border-red-300 bg-red-50' : 'bg-card border-neutral-200'
      )}
    >
      {/* Left side: Icon + Info */}
          ...
          <div className="text-sm text-muted-foreground">
            {isAuthorized ? (
              ...
              <span className="text-red-500 flex items-center gap-1">
                ...
                Доступ запрещён - дай в Системных настройках
              </span>
            ) : (
