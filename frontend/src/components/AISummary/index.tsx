...
export const AISummary = ({ summary, status, error, onSummaryChange, onRegenerateSummary, meeting }: Props) => {
  ...
  const renderLoadingState = () => (
    <div className="w-full p-4 bg-accent border border-primary/20 rounded-lg">
  ...
  if (!hasContent && status === 'completed') {
    return (
      <div className="w-full p-4 bg-secondary border border-border rounded-lg text-center">
  ...
  return (
    <div className="relative">
      ...
      {contextMenu.visible && selectedBlocks.length > 0 && (
        ...
        >
          <button
            className="w-full px-4 py-2 text-left hover:bg-secondary flex items-center space-x-2"
          ...
          <button
            className="w-full px-4 py-2 text-left hover:bg-secondary text-destructive flex items-center space-x-2"
      ...
      {/* <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="px-2 py-1 text-sm bg-secondary hover:bg-secondary rounded-md flex items-center space-x-1"
          >
            <span>📋</span>
            <span>Copy</span>
          </button>
