...
export function LanguageSelection({
  ...
  const handleLanguageChange = async (languageCode: string) => {
    ...
    try {
      ...
      toast.success("Язык распознавания сохранён", {
        description: `Установлен: ${languageName}`
      });
    } catch (error) {
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <select
          ...
          className="w-full px-3 py-2 text-sm bg-card border border-border rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 disabled:text-gray-500"
        >
