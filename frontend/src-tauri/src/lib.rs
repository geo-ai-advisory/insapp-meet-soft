...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        // Авто-обновление через GitHub Releases (проверка при старте + кнопка в UI)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            pty_terminal_commands::ai_summary_run_batch,
            pty_terminal_commands::ai_summary_cancel_batch,
            pty_terminal_commands::ai_summary_batch_running,
            pty_terminal_commands::ai_summary_batch_status,
            pty_terminal_commands::ai_summary_status,
            pty_terminal_commands::ai_summary_set_auto,
            pty_terminal_commands::ai_summary_generate,
            pty_terminal_commands::ai_summary_jobs,
            ...
            insapp_server_commands::insapp_sync_pending,
